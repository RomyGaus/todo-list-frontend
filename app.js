          ...
          <div class="row">
            <div class="col">
              <div class="p-1 pt-3 mb-3">
                <button id="new-todo" class="btn btn-sm btn-info">New Todo</button>
              </div>
            </div>
          </div>
        `;
    ...
    if (this.mode === "form") {
      let html = `
          <div class="row">
            <div class="col">
              <div class="p-1 pt-3 mb-3">
                <button id="back-list" class="btn btn-sm btn-secondary">Back</button>
              </div>
            </div>
          </div>
        `;
          ...
          <div class="col">
            <div class="d-flex justify-content-between border border-info border-top-0 border-end-0 border-bottom-1 border-start-0 p-1">
              ...
              <div class="d-flex gap-2">
                ...
                <i id="delete-todo-${
                  todo.id
                }" class="bi bi-x-square-fill" title="delete"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col">
            <form class="p-1">
              ...
              <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="todo-completed">done?</label>
              </div>
              ...
              ${
                this.currentTodo.id === 0
                  ? `<button type="submit" id="todo-submit-next" class="btn btn-info" data-id="${this.currentTodo.id}">Another One</button>`
                  : ""
              }
            </form>
          </div>
